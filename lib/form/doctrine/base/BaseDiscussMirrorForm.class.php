...
/**
 * DiscussMirror form base class.
 *
 * @method DiscussMirror getObject() Returns the current form's model object
 *
 * @package    vogue
 * @subpackage form
 ...
 */
abstract class BaseDiscussMirrorForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('discuss_mirror[%s]');
