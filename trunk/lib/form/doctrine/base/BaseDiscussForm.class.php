...
/**
 * Discuss form base class.
 *
 * @method Discuss getObject() Returns the current form's model object
 *
 * @package    vogue
 * @subpackage form
 ...
 */
abstract class BaseDiscussForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('discuss[%s]');
