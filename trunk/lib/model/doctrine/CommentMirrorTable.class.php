 ...
 */
class CommentMirrorTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object CommentMirrorTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('CommentMirror');
    }
    ...
    public function getPager($params = array(), $page=1)
    {
        ...
        $pager = new sfDoctrinePager('CommentMirror', sfConfig::get('app_pager', 30));
        $pager->setPage($page);
        $pager->setQuery($q);
        $pager->init();
