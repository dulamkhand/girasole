 ...
 */
class DiscussTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object DiscussTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('Discuss');
    }
    
    
    public function updateNbLove($id, $nbLove)
    {
        $q = Doctrine_Query::create()->update('Discuss')
            ->set('nb_love', $nbLove)
            ->where('id = ?', $id)
            ->execute();
    }
    ...
    public function getPager($params = array(), $page=1)
    {
        ...
        $pager = new sfDoctrinePager('Discuss', sfConfig::get('app_pager', 30));
        $pager->setPage($page);
        $pager->setQuery($q);
        $pager->init();
