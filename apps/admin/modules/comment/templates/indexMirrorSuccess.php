...
<form action="<?php echo url_for('comment/indexMirror')?>" method="GET">
    <b>ContentId</b> &nbsp; 
...
<br clear="all">
<br clear="all">
<form action="<?php echo url_for('comment/cmdMirror')?>" method="POST">
  <table width="100%">
    <thead>
      <tr>
        <th>#</th>
    ...
    <tbody>
      ...
      <?php endforeach; ?>
      <tr><td colspan="10"><?php echo pager($pager, 'comment/indexMirror?objectId='.$sf_params->get('objectId').'&keyword='.$sf_params->get('keyword'))?></td></tr>
    </tbody>
  </table>
</form>
