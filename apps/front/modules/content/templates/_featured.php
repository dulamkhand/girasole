<?php use_stylesheet('/addons/flexslider/featured.css');?>
<?php $host = sfConfig::get('app_host')?>

<?php $rss = Doctrine::getTable('Content')->doFetchArray(array('orderBy'=>'updated_at DESC, category_id ASC', 'isFeatured'=>'1', 'type'=>$type, 'limit'=>4));?>
  ...
  <ul class="slides">
    <?php foreach ($rss as $rs):?>
      ...
      <li style="position:relative;">
          ...
          <?php echo image_tag($rs['cover'], array("style"=>"max-height:337px;width:450px;",'class'=>''));?>
          
          <div style="position:absolute;left:10px;bottom:10px;width:350px;height:120px;background:none repeat scroll 0 0 rgba(255, 255, 255, 0.8);
              ...
              <div style="text-align:center;color:#000;" class="intro">
                  <?php echo myTools::utf8_substr(striptags($rs['intro']), 0, 150)?> ...
              </div>
