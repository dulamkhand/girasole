...
<a href="<?php echo url_for('content/branch2?type='.$type.'&catId='.$cats[$position]['id'])?>" class="title-branch"><?php echo $cats[$position]['name']?></a>
...
<ul class="none">
  ...
  <?php foreach ($rss as $rs):?>
    <li style="margin:0;padding:10px 0;border-bottom:1px dotted #ccc;height:230px;position:relative;" class="intro">
        <?php if($rs['cover']):?>
